...
class MainActivity : AppCompatActivity() {
    ...
    class MyAdapter(private val data: Array<Data?>, private val view: Int) :
        BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View, parent: ViewGroup): View {
            ...
            convertView =LayoutInflater.from(convertView.context).inflate(view,parent,false)
                //getLayoutInflater().inflate(view, parent, false)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val transAdapter = MyAdapter(transData, R.layout.trans_list2)
